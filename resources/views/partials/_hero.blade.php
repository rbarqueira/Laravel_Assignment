<section class="relative h-72 bg-gray-400 flex flex-col justify-center align-center text-center space-y-4 mb-4">
  ...
  <div class="z-10">
    <h1 class="text-6xl font-bold uppercase text-white">
      Books<span class="text-black">Zone</span>
    </h1>
    <p class="text-2xl text-gray-200 font-bold my-4">
      Find or post books to try!
    </p>
    <div>
      @auth
      @else
